...
const NominateDepartmentHeadsManagersOfTheYear = () => {  window.location.replace("https://www.academicjobs.com/");
    const [sendEmail, {
...
export default NominateDepartmentHeadsManagersOfTheYear;