...
const NominatePresidentViceChancellorOfTheYear = () => {  window.location.replace("https://www.academicjobs.com/");
    const [sendEmail, {
...
<div className="  "> 
 ...
 <li className="mb-2">Researcher</li>
...
export default NominatePresidentViceChancellorOfTheYear;