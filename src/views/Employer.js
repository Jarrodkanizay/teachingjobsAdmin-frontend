...
const Employer = () => {  
  ...
  // window.location.replace("https://www.academicjobs.com/employer/:name/:id?");
  ...
  //window.location.replace(`https://www.academicjobs.com/employers/name/${id}`);
  ...
  if (isLoading) {
    ...
    window.location.replace(`https://www.academicjobs.com/employers/${company_name?.replace(/\W+/g, '-').toLowerCase()}/${id}`);
