...
const HR2 = () => {  window.location.replace("https://www.academicjobs.com/hr-jobs");
      ...
      <div className="blurb text-left py-8 px-4">
        ...
        <div className="newLine max-w-screen-2xl mx-auto ">
          ...
          <div className="bg-white flex flex-col  ">
            <h2 className="text-1xl font-bold py-1 px-7 border-2 border-[#00aeef] text-[#00aeef] rounded-3xl shadow-md mb-4 mt-8 ">
